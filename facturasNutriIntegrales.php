...
<body>
<section>
    <h2><center><img src="img/nutriBanner.png" height="100" /></center></h2>
    <br />
 ...
 <div class="modal fade" id="modalAsistencia" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
			...
			$resultado4 = mysql_query("SELECT razon_social, nit_empresa FROM empresa WHERE nit_empresa='88195885-8' order by razon_social ASC");
			...
			?>
              ...
              <h4 class="modal-title" id="myModalLabel"><b>Registro de Facturas</b></h4>
            </div>
            <div class="modal-body">
            <fieldset><legend>Generar Factura</legend>
				<table class="tbl-registro" width="100%">
                	<tr>
              ...
              <td>
                ...
                <div id="mensaje"></div>
                <fieldset><legend>Registrar Detalles</legend>
                <?php 
