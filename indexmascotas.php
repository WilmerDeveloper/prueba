...
<section class="sectionF">
    <h2><center><img src="img/banner1.png" height="100" /></center></h2>
    <br />
   ...
   <form action="buscarf.php" class="formulario" method="post">
    ...
    <table class="table table-bordered table-condensed table-hover">
        <thead>
            <tr>
                <th bgcolor="#CCCCCC"><center>ITEM</center></th>
                <th bgcolor="#CCCCCC"><center>PROPIETARIO</center></th>
                <th bgcolor="#CCCCCC"><center>BARRIO</center></th>
                <th bgcolor="#CCCCCC"><center>DIRECCION</center></th>
                <th bgcolor="#CCCCCC"><center>TELEFONO</center></th>
                <th bgcolor="#CCCCCC"><center>CANINOS</center></th>
                <th bgcolor="#CCCCCC"><center>FELINOS</center></th>
                <th bgcolor="#CCCCCC"><center>CASTRADOS</center></th>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <h4 class="modal-title" id="myModalLabel"><b>Resultado de la operación</b></h4>
             ...
             <center>
            		<img src="img/del.jpg" height="140" />
            </center> 
