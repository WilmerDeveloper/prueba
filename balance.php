...
<section class="sectionF">
    <h2><center><img src="img/bal.png" height="100" /></center></h2>
    <br />
...
$resultado1 = mysql_query("SELECT SUM(valor_neto) FROM factura WHERE fecha_fac BETWEEN '$fec1'  AND '$fec2' AND estado='pagada'");
...
//while($mostrar = mysql_fetch_array($resultado1)){
	...
	echo '<tbody>';
	echo '<tr>';
	echo  '<td>'."Ingresos Netos".'</td>';
	echo '<td align="right">'.$in.'</td>';
	/*echo '<td>'.$mostrar['num_cli'].'</td>';
	echo '<td>'.$mostrar['fecha_fac'].'</td>';
	echo '<td>'.$mostrar['valor_fact'].'</td>';*/
	//echo '<td>'.$mostrar['num_fact'].'</td>';
...
<center><a href="indexbalance.php"><img src="img/regresar.png" height="100" /></a></center>
</html>